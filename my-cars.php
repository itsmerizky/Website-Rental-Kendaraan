...
<title>Sewa.in | Vehicles Listing</title>
<!--Bootstrap -->
  ...
  { ?>
      <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            <h5><a href=""><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a></h5>
            ...
            <a href="" class="btn" style="background-color:#c61919" disabled="disabled">You can't Book Yourself <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
<?php  }
  else { ?>
...
<option value="Diesel">Diesel</option>
              ...
              <div class="form-group">
                <button type="submit" style="background-color:#c61919" class="btn btn-block"><i class="fa fa-search" aria-hidden="true"></i> Search Car</button>
              </div>
            </form>
          </div>
        </div>
...
<!--Back to top-->
<div id="back-top" class="back-top"> <a href="#top" style="background-color:#c61919"><i class="fa fa-angle-up" aria-hidden="true"></i> </a> </div>
<!--/Back to top--> 
